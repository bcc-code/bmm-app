...
namespace BMM.Api
{
    public class BMMClient : IBMMClient
    {
        ...
        public ISharedPlaylistClient SharedPlaylist { get; private set; }

        public IBrowseClient Browse { get; private set; }
        ...
        private void InitClients(IRequestHandler requestHandler, ApiBaseUri uri, ILogger logger)
        {
            ...
            Browse = new BrowseClient(requestHandler, uri, logger);
        }
    }
}