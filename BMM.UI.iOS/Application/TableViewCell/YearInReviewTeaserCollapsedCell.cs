...
{
    public partial class YearInReviewTeaserCollapsedCell : BaseBMMTableViewCell, IEventsHoldingTableViewCell
    {
            ...
            : base(handle)
        {
            this.DelayBind(() =>
            {
                var set = this.CreateBindingSet<YearInReviewTeaserCollapsedCell, YearInReviewTeaserPO>();
