...
{
	[Register ("ExploreNewestViewController")]
	partial class ExploreNewestViewController
	{
		[Outlet]
		...
		[Outlet]
		UIKit.UIView AslaksenTeaser { get; set; }
		...
		[Outlet]
		UIKit.UIView BmmRadiosView { get; set; }
		...
		void ReleaseDesignerOutlets ()
		{
			...
			if (AslaksenTeaser != null) {
				AslaksenTeaser.Dispose ();
				AslaksenTeaser = null;
			}
			...
			if (BmmRadiosView != null) {
				BmmRadiosView.Dispose ();
				BmmRadiosView = null;
			}
