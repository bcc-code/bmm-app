...
public class iOSTrackOptionsAction : BasePrepareTrackOptionsAction
{
    public iOSTrackOptionsAction(IConnection connection,
    ...
    protected override string PlayNextIcon => ImageResourceNames.IconPlayMini;
}