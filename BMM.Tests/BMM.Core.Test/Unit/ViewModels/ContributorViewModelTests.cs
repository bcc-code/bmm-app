...
namespace BMM.Core.Test.Unit.ViewModels
{
    ...
    public class ContributorViewModelTests : BaseViewModelTests
    {
        ...
        public async Task Refresh_CheckIfRefreshWorks()
        {
            ...
            Client.Setup(x => x.Contributors.GetTracks(It.IsAny<int>(), It.IsAny<int>(),It.IsAny<int>(),It.IsAny<IEnumerable<string>>()))
        ...
        {
            // Arrange
            Client.Setup(x => x.Contributors.GetTracks(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), null)).Returns(Task.FromResult<IList<Track>>(null));
            ...
            // Assert
            Client.Verify(x => x.Contributors.GetTracks(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), null), Times.Once);
        }
