...
namespace BMM.UI.Droid.Application.Implementations.Support;

public class DroidOldSecureStorage : OldSecureStorage
{
        public static bool LegacyKeyHashFallback { get; set; } = true;

        static readonly object locker = new object();

        protected override Task<string> PlatformGetAsync(string key)
        {
        ...
        protected override Task PlatformSetAsync(string key, string data)
        {
            var context = Platform.AppContext;
        ...
        protected override bool PlatformRemove(string key)
        {
            var context = Platform.AppContext;
        ...
        protected override void PlatformRemoveAll() =>
...
class AndroidKeyStore
{
    ...
    internal static int SdkInt => _sdkInt ??= (int)Build.VERSION.SdkInt;

    internal static bool HasApiLevel(BuildVersionCodes versionCode) => SdkInt >= (int)versionCode;
    ...
    ISecretKey GetKey()
    {
        ...
        useSymmetric = Preferences.Get(useSymmetricPreferenceKey, HasApiLevel(BuildVersionCodes.M), OldSecureStorage.Alias);
    ...
    {
        Preferences.Set(useSymmetricPreferenceKey, true, OldSecureStorage.Alias);
    ...
    KeyPair GetAsymmetricKeyPair()
    {
        ...
        Preferences.Set(useSymmetricPreferenceKey, false, OldSecureStorage.Alias);
...
#pragma warning restore CS0618
    ...
    internal byte[] Encrypt(string data)
    {
        ...
        Buffer.BlockCopy(iv,
            ...
            0,
            iv.Length);
        Buffer.BlockCopy(encryptedBytes,
            0,
            r,
            iv.Length,
