...
{
    public class StandardChurchViewHolder : MvxRecyclerViewHolder
    {
        ...
        public StandardChurchViewHolder(
            View itemView,
        ...
        private void Bind()
        {
            ...
            var set = this.CreateBindingSet<StandardChurchViewHolder, HvheChurchPO>();
        ...
        private Color GetBackgroundColor(GameNights gameNight)
        {
            int colorId = gameNight switch
            {
                ...
                _ => ResourceConstant.Color.background_two_color
            };
